...
public class PaintViewTest extends BaseActivity implements OnClickListener,
	...
	private void saveDrawing() {
		final CustomAlertDialog saveDialog = new CustomAlertDialog(
				PaintViewTest.this, getString(R.string.save_drawing_message));
	 ...
	 * @return Alert Dialog
	 */
	private CustomAlertDialog getDialogForColorPicker(int oldColor) {
	 ...
	 * @return Alert Dialog
	 */
	private CustomAlertDialog getDialogForBrushSize(int oldBrushSize) {
	...
	private CustomAlertDialog getDialogForBrushType() {
		...
		BrushAdapter adapter = new BrushAdapter(PaintViewTest.this,
				getResources().getStringArray(R.array.brush_list));

		final CustomAlertDialog dialog = new CustomAlertDialog(
				PaintViewTest.this, "", R.style.CustomListDialogStyle);
