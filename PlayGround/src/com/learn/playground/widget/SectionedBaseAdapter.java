...
public abstract class SectionedBaseAdapter extends BaseAdapter implements PinnedSectionedHeaderAdapter {
    ...
    /**
     * Holds the calculated values of @{link getSectionHeaderForPosition}
     */
    ...
    public final Object getItem(int position) {
        return getItem(getSectionHeaderForPosition(position), getPositionInSectionForPosition(position));
    }

    @Override
    public final long getItemId(int position) {
        return getItemId(getSectionHeaderForPosition(position), getPositionInSectionForPosition(position));
    }

    @Override
    public final View getView(int position, View convertView, ViewGroup parent) {
        if (isSectionHeader(position)) {
            return getSectionHeaderView(getSectionHeaderForPosition(position), convertView, parent);
        }
        return getItemView(getSectionHeaderForPosition(position), getPositionInSectionForPosition(position), convertView, parent);
    }

    @Override
    public final int getItemViewType(int position) {
        if (isSectionHeader(position)) {
            return getItemViewTypeCount() + getSectionHeaderViewType(getSectionHeaderForPosition(position));
        }
        return getItemViewType(getSectionHeaderForPosition(position), getPositionInSectionForPosition(position));
    }
