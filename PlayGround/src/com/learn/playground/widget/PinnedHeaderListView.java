...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
	...
	public static interface PinnedSectionedHeaderAdapter {
		...
		public int getSectionHeaderForPosition(int position);
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		int section = mAdapter.getSectionHeaderForPosition(firstVisibleItem);
	...
	public static abstract class OnItemClickListener implements
		...
		public void onItemClick(AdapterView<?> adapterView, View view,
			...
			if (adapterView.getAdapter().getClass()
					.equals(SectionedBaseAdapter.class)) {
				...
				int section = adapter.getSectionHeaderForPosition(rawPosition);
				int position = adapter
						.getPositionInSectionForPosition(rawPosition);
				...
				SectionIndexerBaseAdapter adapter;
				if (adapterView.getAdapter().getClass()
						.equals(HeaderViewListAdapter.class)) {
					HeaderViewListAdapter wrapperAdapter = (HeaderViewListAdapter) adapterView
							.getAdapter();
					adapter = (SectionIndexerBaseAdapter) wrapperAdapter
							.getWrappedAdapter();
				} else {
					adapter = (SectionIndexerBaseAdapter) adapterView
							.getAdapter();
				}
				int section = adapter.getSectionHeaderForPosition(rawPosition);
				int position = adapter
						.getVirtualPositionOfDataItem(rawPosition);
